...
const items: readonly FaqItem[] = [
  {
    ...
    question: "這要花多少錢？",
    answer:
      "初步評估階段的投入通常是幾萬到十幾萬台幣——取決於你的產品類型和目標市場。測試階段大約 50–100 萬。我們會在第一次聊天時給你一個合理的預算範圍，你不用承諾任何事，也不會拿到天價報價。",
    takeaway: "我們會在第一次對話就給你預算範圍。",
    icon: <MoneyIcon />,
  },
  {
    num: "02",
    accent: "gold",
    topic: "時程",
    question: "從開始到產品上架要多久？",
    answer:
      "平均 6–9 個月，取決於產品類型和目標市場的認證要求。食品和保健品通常較長（9–12 個月），消費電子產品較快（4–6 個月）。我們會在評估報告裡給你明確的時間表，不會讓你一直等。",
    takeaway: "食品 9–12 個月 · 消費電子 4–6 個月。",
    icon: <ClockIcon />,
  },
  {
    num: "03",
    accent: "ember",
    topic: "風險",
    question: "如果評估後發現我的產品不適合怎麼辦？",
    answer:
      "那反而是最好的結果之一——你省下了幾百萬的冤枉錢。我們會老實告訴你為什麼，也會告訴你未來什麼條件改變後可以再考慮。有時候「現在不適合」只是「換個方式更好」。",
    takeaway: "省下冤枉錢，比賺到還重要。",
    icon: <ShieldIcon />,
  },
];
