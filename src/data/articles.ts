...
export const articles: readonly Article[] = [
  {
    ...
    category: "出海實戰",
    date: "2026-04-23",
    title: "政府這次是認真的——海外參展補助從 4 萬跳到 16 萬，但你只有兩個月能動",
    summary:
      "115 年度海外參展補助因應國際關稅情勢加碼至歷年最優：每展最高 NT$16 萬、補助比例上拉到 90%。第 2 次公告預計 4-5 月開放，經費用罄即止。這篇寫給還沒申請過、也想知道怎麼不卡核銷的老闆。",
    readTime: "8 分鐘",
    color: "gold",
    content: [
      "2026 年 4 月，經濟部貿易署把海外參展補助的上限從往年的每展 4–5 萬加碼到 NT$16 萬，補助比例從 50% 左右拉高到 90%。這不是我在看新聞時興奮寫的標題，這是依《因應國際情勢強化經濟社會及民生國安韌性特別條例》下來的真金白銀。",
      "我寫這篇文章有兩個理由。第一，這是這個補助從民國 108 年以來最優的一次，而且時間窗口只到 12 月底。第二，多數找上我們的中小企業老闆，第一次聽到這個數字時反應都是「真的假的？那我之前申請的那個是什麼？」——所以我想把該知道的事寫清楚，免得你錯過或卡在核銷。",
      "## 先看三個數字",
      "**16 萬**。這是單一展覽的補助上限。結構是這樣：一個攤位補助 12 萬，每增加一個攤位再加 1 萬，封頂 16 萬。也就是如果你一次開 5 攤，頂多拿到 16 萬，不是 12 + 4×1 = 16 萬剛好——是這個上限擋住了。",
      "**90%**。這是補助比例的天花板。公式是「符合補助項目金額 × 90%」，企業至少自籌 10%。舉個例：你場地租金花了 18 萬，90% 就是 16.2 萬，但攤位有上限 16 萬，所以實拿 16 萬；如果只花了 10 萬，那就是 9 萬。不是每家企業都拿得到封頂——你的實際花費才是基礎。",
      "**4–5 月**。這是第 2 次公告的預計開放時間（第 1 次上半年梯次已於 114 年底截止）。展覽執行期是 115 年 7 月 1 日到 12 月 31 日。換句話說，如果你下半年有展要去，現在就是申請時機。再次重點：**經費用罄即止**，不是先搶先贏——是用完就沒了，即使你的條件完全符合。",
      "## 為什麼這次加碼",
      "單純一句話：因應國際關稅情勢。美國這兩年的關稅政策讓台灣很多輸美廠商直接承壓，經濟部的思考是——「既然成本線壓縮了，那就把出口廠商推去更多市場，分散風險」。海外參展是接觸買手最快的路徑，所以補助額度往上拉。",
      "這個加碼的另一個訊號是：政府認為 2026 下半年到 2027 是台灣廠商**重新洗市場**的時間窗口。你的上游客戶可能在找新供應商、你的下游買家可能在重新洗名單、你的競爭對手可能還沒反應過來。這個時候出去展，投資報酬率是平常的 2 倍以上——而補助的存在，只是讓你「不去會後悔」的理由更充分。",
      "## 誰該搶這個梯次",
      "依照我們陪跑過的案子經驗，三類人最值得搶：",
      "**一、第一次出海的食品、消費品、電子零組件業者。** 這類展會（例如美國的 Fancy Food Show、德國的 Anuga、泰國的 THAIFEX、越南的 Food & Hotel Vietnam）一個攤位租金隨便都 10 萬起跳。有了 16 萬補助，你的實際投入可能只剩 2-3 萬——這是大幅壓低試水成本的機會。",
      "**二、過去 1-2 年輸美營收下滑的製造業。** 關稅戰之後，你原本的美國客戶可能在砍單或轉單。這個補助鼓勵你去東南亞、歐洲、中東的展會開新市場，而且新創與新南向農業業者有特殊優先待遇。",
      "**三、已經有海外代理商、但想直接接觸終端買家的品牌。** 展覽是「跳過代理商跟買手直接對話」的少數機會。拿到補助之後，你一個展的現金流壓力幾乎歸零——可以多試兩三個展。",
      "反過來說，兩類人**不建議**現在搶：",
      "**一、還沒有產品包裝、SKU 都還不穩定的團隊。** 展覽是要準備樣品、型錄、話術、切結書的。如果你的產品這週跟下週不一樣，你拿補助去展會只會把品牌第一印象做壞。先把產品穩住再說。",
      "**二、從來沒出過國的業務主管。** 展會不是把型錄攤開就有訂單的場合。沒有演練過展場話術、沒有買手會議排程、沒有後續 follow up 機制——去了也是白去。這筆錢寧可花在先上兩次展會培訓，再申請下一梯。",
      "## 三個最容易踩雷的點",
      "我們協助客戶申請過這類補助，下面這三件事是新手最常卡住的：",
      "**一、款項是展後核銷才撥款，不是核定就給。** 很多老闆以為「申請通過就能拿到錢」——不是。流程是：展前申請 → 審查核配（保留額度）→ 赴展 → 展後 1 個月內檢附單據 → 審查通過後才撥款。換句話說，你要先自己墊錢，展完再把錢拿回來。這對現金流緊的公司是要命的事，請提前跟會計算好。",
      "**二、攤位明顯處必須張貼「臺灣一等一」標誌，而且 A3 以上。** 這是強制規定。忘了貼或貼得太小，展後核銷時照片不過，整筆補助可能要退回去。這個點在官方公告上寫得清楚，但我每年都會碰到 2-3 家客戶忘記，回來哭。",
      "**三、不是每個費用都能補。** 可補的有 6 項：場地租金（必要項目）、場地佈置費、口譯費（每日上限 NT$14,000）、展品運費（限至國外，國內運費不得申請）、型錄 DM 名片印刷費、文宣廣告費。差旅費（機票、住宿、員工薪資）不在補助範圍內。很多人以為「整趟出差都能補」——不是。",
      "另外幾個細節容易忘：口譯人員必須是非參展廠商且要簽切結書（不能叫自己同事翻）、印刷品要提供實品或照片樣本（不能只有設計檔）、文宣廣告要附實品照片樣本（純數位投放要有截圖）。這些都是在核銷階段會逐項檢查的。",
      "## 兩個月的申請時程建議",
      "假設你是第一次申請，下面是我們建議的節奏：",
      "**第 1 週**——先決定要去哪個展。看展會的 B2B 屬性、買手組成、台灣參展團是否已經組好。貿易署每年會公告「重點支持的海外展覽清單」，先從清單內挑會比較穩。",
      "**第 2-3 週**——準備申請文件：公司基本資料、展覽資訊、預算表。預算表是關鍵，每一項費用要寫清楚金額、廠商、時程。預算寫太粗糙會被退件補件，補件一次多花兩週。",
      "**第 4 週**——線上送件。貿易署的系統會給你一個案號，後續所有溝通都用這個案號。送件後大約 4-6 週會收到審查結果。",
      "**展前 2-3 週**——如果拿到核配，開始處理展品運輸（有國際物流安排的話這時要下單）、口譯招募、印刷品打樣、攤位佈置發包。這個階段的作業時間如果壓縮，很容易在開展當天出狀況。",
      "**展後 1 個月內**——核銷。這是最繁瑣的一段：所有單據正本、發票、攤位照片、標誌照片、口譯切結書、印刷品實品/樣本通通要整理成核銷資料包。我們有客戶在這一步弄了兩週才送出——不是文件少，是發票上的廠商名稱跟預算表對不起來，或是單據忘了蓋公司章。",
      "## 鹿飛怎麼幫",
      "我們不是代辦公司，申請書本來就是你公司自己要送的（這也是規定）。但我們能幫你做三件事：",
      "**一、選對展會**。我們手上有北美和東南亞主要 B2B 展會的買手組成、歷年成交規模、台灣團口碑的第一手資料。「去哪個展」這個決定比「補助多少」重要十倍——展選錯，補助 16 萬也救不回來。",
      "**二、把預算表和計畫書寫到能過審的程度**。我們提供市場分析、策略規劃、執行方案，讓你只要整理成官方格式就好。有客戶是拿我們的評估報告直接當申請依據，審查委員看了會覺得「這家是有準備的」。",
      "**三、展中跟展後的現場支援**。買手會議怎麼排、話術怎麼寫、跟進信怎麼發、樣品怎麼寄——這些不在補助範圍內，但決定你這筆錢花得值不值。我們從躍馬企業 42 年的國際物流經驗切進來，連展品出關和退稅這些事都能一起處理。",
      "---",
      "最後一句話：**補助是手段，不是目的**。如果你本來就要去展會，這個加碼讓你少花 5-10 萬，那非常划算；但如果你是因為「反正有補助才去」，我會建議先做一下 2 分鐘評估，看看你現在的產品和市場狀況適不適合。一個錯誤的展會，即使補助全拿也是賠錢的。",
      "如果你想直接聊具體怎麼執行，或是要我們幫你看展會選單，歡迎直接找我——現在開始規劃，4-5 月送件剛好。",
    ],
  },
  {
