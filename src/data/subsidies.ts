...
export const SUBSIDIES: readonly Subsidy[] = [
  ...
  },
  {
    ...
    amount: "研發轉型補助 + 貿易融資",
    amountNote:
      "研發補助最高 NT$500 萬 · 貿易融資額度依個案評估 · 訂單爭取補貼另核",
    oneLiner:
      "美國關稅變動下，產地轉移（如中國 → 越南）是最直接的應對。這個方案整合研發補助、訂單補貼、貿易融資三個工具，為輸美受衝擊的企業而生。",
    whoFor: [
      "原本輸美、受關稅衝擊的製造業",
      "考慮產地轉移到東南亞或墨西哥的企業",
      "需要爭取海外新訂單的出口商",
    ...
    coversDetail: [
      {
        title: "研發與製程轉型補助",
        note: "產品重新設計、製程改造、關鍵零組件國產化。須提出轉型計畫與預期效益。",
        limit: "最高 NT$500 萬",
      },
      {
        title: "海外新訂單爭取補貼",
        note: "參加海外買主媒合會、海外訂單促成的行銷支出、客製化樣品費。",
        limit: "依個案核定",
      },
      {
        title: "貿易融資 / 信保支持",
        note: "中國信託、臺銀等配合銀行提供低利貿易融資；信保基金額度加碼。",
        limit: "額度依評估",
      },
      {
        title: "供應鏈重組顧問輔導",
        note: "外部顧問諮詢費、供應商媒合、合約審閱。中小企業可透過中企署協助媒合。",
        limit: "部分免費",
      },
      {
        title: "海外設廠評估與法遵",
        note: "東南亞（越南、印尼、泰國）或墨西哥設廠評估、當地法務會計諮詢、廠址踏勘差旅。",
        limit: "核實報銷",
      },
      {
        title: "目標市場認證 / 檢測費",
        note: "新市場所需之產品認證（FDA、CE、JIS 等）、測試費、智財權重新註冊。",
        limit: "核實報銷",
      },
    ],
    processSteps: [
      { title: "資格登記", note: "具輸美實績的企業登記受衝擊情形與轉型意願。" },
      { title: "個案診斷", note: "產發署或委辦單位進行一對一診斷，盤點需求。" },
      { title: "提案與配對", note: "針對診斷結果提案，配對研發補助 / 融資 / 訂單三個工具。" },
      { title: "核定撥款", note: "研發補助經審查後撥款；融資由配合銀行執行；訂單補貼事後核銷。" },
      { title: "成效追蹤", note: "每季提報產地轉移進度、新訂單金額、員工留任等指標。" },
    ],
    importantNotes: [
      "進入本方案需先有「輸美實績」（通常過去 2 年有對美出口紀錄）",
      "三個工具可擇一或疊加申請，但同一筆費用不能重複請款",
      "產地轉移不只是設廠，還涉及 HS Code 原產地認定——鹿飛搭配 TradePilot 可協助試算",
      "方案是長期開放，但名額與預算每年度重新編列，建議盡早登記",
    ],
    lufeAngle:
      "鹿飛做過實際案例「中國轉越南」的產地轉移，從設廠評估、供應商媒合、出口流程到 HS Code 重新認定全程陪跑。這個補助是我們關稅優化服務的財務助力——你用補助降低轉移成本，我們把路徑走通。",
    stage: "optimize",
    accent: "ember",
    deadline: "長期開放",
    applicationNote: "依個案評估 · 名額與預算每年度編列",
    iconKey: "factory",
  ...
  },
  {
    ...
    amount: "免費培訓 + 廣告投放資源",
    amountNote:
      "政府資源為主（非現金補助）· 平台廣告資源依篩選結果配發 · 部分課程付費但大幅補貼",
    oneLiner:
      "Amazon、Shopee、Lazada、蝦皮全球、Rakuten 上架與營運全程輔導。政府免費教你怎麼玩，鹿飛幫你真的賣出去。",
    whoFor: [
      "想上架 Amazon / Shopee / Lazada 的品牌",
      "需要跨境電商基礎培訓的團隊",
      "想申請平台廣告資源的賣家",
      "預算有限、想先試水溫的中小企業",
    ],
    ...
    coversDetail: [
      {
        title: "跨境電商平台培訓課程",
        note: "Amazon / Shopee / Lazada / Rakuten 實體與線上課程，從開店、選品、listing 優化到廣告投放。",
        limit: "多數免費",
      },
      {
        title: "商品上架與內容優化輔導",
        note: "Listing 撰寫、主圖優化、A+ Content 設計、關鍵字研究。部分服務採補貼方式收費。",
        limit: "部分付費",
      },
      {
        title: "平台廣告投放資源",
        note: "Amazon PPC、Facebook / Google 廣告資源包。須經資格審查與商品適配評估後配發。",
        limit: "依篩選配發",
      },
      {
        title: "跨境金流 / 物流諮詢",
        note: "PingPong、WorldFirst 等金流方案媒合；海外倉、FBA、三地倉物流諮詢。",
        limit: "諮詢免費",
      },
      {
        title: "一對一顧問診斷",
        note: "外貿協會派遣或委外顧問提供電商營運診斷，通常 1-2 小時一次。",
        limit: "名額有限",
      },
      {
        title: "海外買主媒合與 B2B 商機",
        note: "透過 Taiwantrade 平台獲得海外詢單、參與線上買主媒合會。",
        limit: "依商機開放",
      },
    ],
    processSteps: [
      { title: "Taiwantrade 註冊", note: "到 taiwantrade.com 註冊企業帳號並完成商品上架。" },
      { title: "報名課程或診斷", note: "依需求報名培訓梯次或申請一對一診斷。" },
      { title: "審查與配對", note: "廣告資源申請須審查公司規模、商品適配性、過去銷售紀錄。" },
      { title: "執行與回報", note: "依配發資源執行，部分需提報成效（點擊率、轉換率、GMV）。" },
      { title: "進階申請", note: "有初步成績後可申請進階補助（例如品牌館、海外實體活動）。" },
    ],
    importantNotes: [
      "這是「資源型」補助，不是現金撥款——多數是免費課程、廣告資源包、商機媒合",
      "廣告資源須經審查，不是人人都拿得到；通常要求商品有基本銷售紀錄",
      "培訓梯次依季度開放，熱門課程（Amazon、Shopee）常秒殺，建議關注梯次公告",
      "跨境電商是長期戰，光靠補助不會讓產品賣起來——策略 / 選品 / 定價才是關鍵",
    ],
    lufeAngle:
      "培訓讓你懂怎麼操作平台，鹿飛幫你決定賣什麼、定價多少、如何選品、怎麼打廣告。免費資源適合試水溫；真要把跨境電商當成營收來源，策略面要同時做。兩者疊加使用最有效率。",
    stage: "assess",
    accent: "sky",
    deadline: "常態招生",
    applicationNote: "依梯次報名 · 課程與資源全年滾動開放",
    iconKey: "cart",
